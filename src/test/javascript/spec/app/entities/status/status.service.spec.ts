...
describe('Service Tests', () => {
  describe('Status Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Status(123, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Status', async () => {
      ...
      it('should partial update a Status', async () => {
      ...
      it('should not partial update a Status', async () => {
      ...
      it('should not return a list of Status', async () => {
        axiosStub.get.rejects(error);
      ...
      it('should not delete a Status', async () => {
