...
class ItemBrandResourceIT {
    ...
    public static ItemBrand createEntity(EntityManager em) {
        ItemBrand itemBrand = new ItemBrand().brandName(DEFAULT_BRAND_NAME);
        return itemBrand;
    }
    ...
    public static ItemBrand createUpdatedEntity(EntityManager em) {
        ItemBrand itemBrand = new ItemBrand().brandName(UPDATED_BRAND_NAME);
        return itemBrand;
    }
    ...
    void createItemBrand() throws Exception {
        ...
        assertThat(testItemBrand.getBrandName()).isEqualTo(DEFAULT_BRAND_NAME);
    }
    ...
    void putExistingItemBrand() throws Exception {
        ...
        updatedItemBrand.brandName(UPDATED_BRAND_NAME);
        ...
        ItemBrand testItemBrand = itemBrandList.get(itemBrandList.size() - 1);
        assertThat(testItemBrand.getBrandName()).isEqualTo(UPDATED_BRAND_NAME);
    }
    ...
    void partialUpdateItemBrandWithPatch() throws Exception {
        ...
        partialUpdatedItemBrand.brandName(UPDATED_BRAND_NAME);
