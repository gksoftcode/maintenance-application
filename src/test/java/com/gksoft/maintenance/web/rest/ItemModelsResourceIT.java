...
class ItemModelsResourceIT {
    ...
    public static ItemModels createEntity(EntityManager em) {
        ItemModels itemModels = new ItemModels().modelName(DEFAULT_MODEL_NAME);
        return itemModels;
    }
    ...
    public static ItemModels createUpdatedEntity(EntityManager em) {
        ItemModels itemModels = new ItemModels().modelName(UPDATED_MODEL_NAME);
        return itemModels;
    }
    ...
    void createItemModels() throws Exception {
        ...
        assertThat(testItemModels.getModelName()).isEqualTo(DEFAULT_MODEL_NAME);
    }
    ...
    void putExistingItemModels() throws Exception {
        ...
        updatedItemModels.modelName(UPDATED_MODEL_NAME);
        ...
        ItemModels testItemModels = itemModelsList.get(itemModelsList.size() - 1);
        assertThat(testItemModels.getModelName()).isEqualTo(UPDATED_MODEL_NAME);
    }
    ...
    void fullUpdateItemModelsWithPatch() throws Exception {
        ...
        partialUpdatedItemModels.modelName(UPDATED_MODEL_NAME);
