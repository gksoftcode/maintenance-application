...
class StatusResourceIT {
    ...
    public static Status createEntity(EntityManager em) {
        Status status = new Status().statusName(DEFAULT_STATUS_NAME);
        return status;
    }
    ...
    public static Status createUpdatedEntity(EntityManager em) {
        Status status = new Status().statusName(UPDATED_STATUS_NAME);
        return status;
    }
    ...
    void putExistingStatus() throws Exception {
        ...
        updatedStatus.statusName(UPDATED_STATUS_NAME);
    ...
    void fullUpdateStatusWithPatch() throws Exception {
        ...
        partialUpdatedStatus.statusName(UPDATED_STATUS_NAME);
