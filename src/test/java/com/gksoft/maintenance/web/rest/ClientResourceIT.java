...
import com.gksoft.maintenance.domain.Client;
import com.gksoft.maintenance.repository.ClientRepository;
...
class ClientResourceIT {
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.fullName(UPDATED_FULL_NAME).mobileNo(UPDATED_MOBILE_NO).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.fullName(UPDATED_FULL_NAME).mobileNo(UPDATED_MOBILE_NO).email(UPDATED_EMAIL);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.fullName(UPDATED_FULL_NAME).mobileNo(UPDATED_MOBILE_NO).email(UPDATED_EMAIL).phoneNumber(UPDATED_PHONE_NUMBER);
