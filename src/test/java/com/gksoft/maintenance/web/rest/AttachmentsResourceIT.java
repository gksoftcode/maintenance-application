...
class AttachmentsResourceIT {
    ...
    private static final String DEFAULT_ATTACH_NAME = "AAAAAAAAAA";
    private static final String UPDATED_ATTACH_NAME = "BBBBBBBBBB";
    ...
    public static Attachments createEntity(EntityManager em) {
        Attachments attachments = new Attachments()
            .attachName(DEFAULT_ATTACH_NAME)
    ...
    public static Attachments createUpdatedEntity(EntityManager em) {
        Attachments attachments = new Attachments()
            .attachName(UPDATED_ATTACH_NAME)
    ...
    void createAttachments() throws Exception {
        ...
        assertThat(testAttachments.getAttachName()).isEqualTo(DEFAULT_ATTACH_NAME);
    ...
    void getAllAttachments() throws Exception {
        ...
        restAttachmentsMockMvc
            ...
            .andExpect(jsonPath("$.[*].attachName").value(hasItem(DEFAULT_ATTACH_NAME)))
    ...
    void getAttachments() throws Exception {
        ...
        restAttachmentsMockMvc
            ...
            .andExpect(jsonPath("$.attachName").value(DEFAULT_ATTACH_NAME))
    ...
    void putExistingAttachments() throws Exception {
        ...
        updatedAttachments.attachName(UPDATED_ATTACH_NAME).attach(UPDATED_ATTACH).attachContentType(UPDATED_ATTACH_CONTENT_TYPE);
        ...
        Attachments testAttachments = attachmentsList.get(attachmentsList.size() - 1);
        assertThat(testAttachments.getAttachName()).isEqualTo(UPDATED_ATTACH_NAME);
    ...
    void fullUpdateAttachmentsWithPatch() throws Exception {
        ...
        partialUpdatedAttachments.attachName(UPDATED_ATTACH_NAME).attach(UPDATED_ATTACH).attachContentType(UPDATED_ATTACH_CONTENT_TYPE);
