  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="maintenanceApp.employee.home.createOrEditLabel"
          data-cy="EmployeeCreateUpdateHeading"
          v-text="$t('maintenanceApp.employee.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.firstName')" for="employee-firstName">First Name</label>
            <input
              type="text"
              class="form-control"
              name="firstName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.lastName')" for="employee-lastName">Last Name</label>
            <input
              type="text"
              class="form-control"
              name="lastName"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.email')" for="employee-email">Email</label>
            <input
              type="text"
              class="form-control"
              name="email"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.phoneNumber')" for="employee-phoneNumber"
              >Phone Number</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.hireDate')" for="employee-hireDate">Hire Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.salary')" for="employee-salary">Salary</label>
            <input
              type="number"
              class="form-control"
              name="salary"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.commissionPct')" for="employee-commissionPct"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.manager')" for="employee-manager">Manager</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.department')" for="employee-department">Department</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.employee.workOrders')" for="employee-workOrders"
              >Work Orders</label
            >
            <select class="form-control" id="employee-workOrders" data-cy="workOrders" name="workOrders" v-model="employee.workOrders">
              <option v-bind:value="null"></option>
              <option
                v-bind:value="
                  employee.workOrders && workOrdersOption.id === employee.workOrders.id ? employee.workOrders : workOrdersOption
                "
