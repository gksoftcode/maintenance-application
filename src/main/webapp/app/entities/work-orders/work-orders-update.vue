  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="maintenanceApp.workOrders.home.createOrEditLabel"
          data-cy="WorkOrdersCreateUpdateHeading"
          v-text="$t('maintenanceApp.workOrders.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.title')" for="work-orders-title">Title</label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.description')" for="work-orders-description"
              >Description</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.startDate')" for="work-orders-startDate"
              >Start Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.endDate')" for="work-orders-endDate">End Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.budget')" for="work-orders-budget">Budget</label>
            <input
              type="number"
              class="form-control"
              name="budget"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.itemSerial')" for="work-orders-itemSerial"
              >Item Serial</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.isWaranty')" for="work-orders-isWaranty"
              >Is Waranty</label
            >
            <input
              type="checkbox"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.notes')" for="work-orders-notes">Notes</label>
            <input
              type="text"
              class="form-control"
              name="notes"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.status')" for="work-orders-status">Status</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.client')" for="work-orders-client">Client</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.itemModels')" for="work-orders-itemModels"
              >Item Models</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.workOrders.itemBrand')" for="work-orders-itemBrand"
              >Item Brand</label
            >
