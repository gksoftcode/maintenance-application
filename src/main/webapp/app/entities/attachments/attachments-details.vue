    ...
    <div class="col-8">
      <div v-if="attachments">
        <h2 class="jh-entity-heading" data-cy="attachmentsDetailsHeading">
          <span v-text="$t('maintenanceApp.attachments.detail.title')">Attachments</span> {{ attachments.id }}
        </h2>
        <dl class="row jh-entity-details">
          <dt>
            <span v-text="$t('maintenanceApp.attachments.attachName')">Attach Name</span>
          </dt>
          <dd>
            <span>{{ attachments.attachName }}</span>
          </dd>
          <dt>
            <span v-text="$t('maintenanceApp.attachments.attach')">Attach</span>
          </dt>
          <dd>
          ...
          <dt>
            <span v-text="$t('maintenanceApp.attachments.workOrdersHistory')">Work Orders History</span>
          </dt>
          <dd>
