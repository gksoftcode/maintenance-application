  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="maintenanceApp.status.home.createOrEditLabel"
          data-cy="StatusCreateUpdateHeading"
          v-text="$t('maintenanceApp.status.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.status.statusName')" for="status-statusName">Status Name</label>
            <input
              type="text"
              class="form-control"
              name="statusName"
              ...
              data-cy="statusName"
              :class="{ valid: !$v.status.statusName.$invalid, invalid: $v.status.statusName.$invalid }"
