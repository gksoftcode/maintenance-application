  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="maintenanceApp.appintment.home.createOrEditLabel"
          data-cy="AppintmentCreateUpdateHeading"
          v-text="$t('maintenanceApp.appintment.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.appintment.appDate')" for="appintment-appDate">App Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.appintment.notes')" for="appintment-notes">Notes</label>
            <input
              type="text"
              class="form-control"
              name="notes"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('maintenanceApp.appintment.client')" for="appintment-client">Client</label>
