...
import com.gksoft.maintenance.repository.AppintmentRepository;
import com.gksoft.maintenance.service.AppintmentService;
...
/**
 * REST controller for managing {@link com.gksoft.maintenance.domain.Appintment}.
 */
@RestController
@RequestMapping("/api")
public class AppintmentResource {
    ...
    public List<Appintment> getAllAppintments() {
        log.debug("REST request to get all Appintments");
        return appintmentService.findAll();
    }
