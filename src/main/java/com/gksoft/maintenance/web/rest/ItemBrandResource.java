...
import com.gksoft.maintenance.service.ItemBrandService;
...
/**
 * REST controller for managing {@link com.gksoft.maintenance.domain.ItemBrand}.
 */
@RestController
@RequestMapping("/api")
public class ItemBrandResource {
    ...
    public List<ItemBrand> getAllItemBrands() {
        log.debug("REST request to get all ItemBrands");
        return itemBrandService.findAll();
    }
