...
import com.gksoft.maintenance.service.ItemModelsService;
...
/**
 * REST controller for managing {@link com.gksoft.maintenance.domain.ItemModels}.
 */
@RestController
@RequestMapping("/api")
public class ItemModelsResource {
    ...
    public List<ItemModels> getAllItemModels() {
        log.debug("REST request to get all ItemModels");
        return itemModelsService.findAll();
    }
