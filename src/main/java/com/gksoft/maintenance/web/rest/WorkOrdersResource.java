...
import com.gksoft.maintenance.service.WorkOrdersService;
...
/**
 * REST controller for managing {@link com.gksoft.maintenance.domain.WorkOrders}.
 */
@RestController
@RequestMapping("/api")
public class WorkOrdersResource {
    ...
    public List<WorkOrders> getAllWorkOrders() {
        ...
        return workOrdersService.findAll();
    }
